...
var api_util = {
    ...
    createTourney: function() {
        ...
        return new Promise(function(resolve, reject) {
            ...
            function submitTourney() {
                ...
                request.post({url: `tournaments.json?tournament[name]=${tournament.name}&tournament[url]=${randomHash()}&tournament[description]=${tournament.description}&tournament[hold_third_place_match]=true&tournament[game_id]=20988&tournament[quick_advance]=true`}, function(error, response, body) {
    ...
    addPlayers: function(tournamentId, userArray) {
      ...
      return new Promise(function(resolve, reject) {
            ...
            userArray.forEach(s => parameterString += `participants[][name]=${s.capCase()}&`);
            ...
            request.post({url: parameterString}, function(error, response, body) {
              console.log(error);
